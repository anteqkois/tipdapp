...
const Navbar = () => {
  ...
  return media === 'mobile' ? (
    <>
      <div className="fixed top-0 left-0 w-full h-12 bg-stone-50 grid grid-cols-[50px_auto_45px] gap-5 items-center z-50">
      ...
      <nav
        className={`fixed -top-full left-0 p-2 w-full duration-300 ${isOpen ? 'translate-y-[calc(200%+55px)]' : 'translate-y-0'}`}
      >
        <ul>
          <li>
            <Link href="/dashboard">
              <p className="flex gap-3 p-4 uppercase font-semibold group rounded text-zinc-600 hover:text-zinc-900 hover:cursor-pointer hover:bg-stone-200">
                <svg
