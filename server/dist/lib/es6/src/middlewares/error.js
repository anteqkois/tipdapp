...
export var notFound = function (req, res, next) {
...
export var catchAsyncErrors = function (handler) {
...
export var catchErrors = function (handler) {
...
export var createValidationErrors = function (errors, status) {
    throw new ValidationErrors(errors, status);
};
export var createValidationError = function (message, title, field, code) {
    throw new ValidationError(field, title, message, code);
};
export var createApiError = function (message, status) {
    throw new ApiError(message, status);
};
export var isOperational = function (err, helpMessage) {
...
export var handleErrors = function (err, req, res, next) {
    ...
    if (err instanceof ZodError) {
        errorLogger.error('ZodError', ValidationErrors.fromZodErrorArray(err.issues).errors);
