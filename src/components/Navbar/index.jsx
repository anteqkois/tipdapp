...
const Navbar = () => {
  ...
  return isMobile ? (
      ...
      >
        <ul>
          <li onClick={() => setIsOpen(false)}>
            <Navlink
              href="/dashboard"
              className="flex gap-3 p-4 font-semibold uppercase group rounded-xl text-neutral-600 hover:text-neutral-900 hover:cursor-pointer hover:bg-neutral-150"
            >
    ...
    <div className="fixed top-0 left-0 w-full h-24 bg-neutral-50 shadow-md px-2 grid grid-cols-[50px_auto_100px] gap-5 place-items-center z-50">
      <div className="flex-center">LOGO</div>
      <nav>
        <ul className="flex p-1 m-3 w-fit rounded-xl bg-neutral-150">
          ...
          <Tooltip content="Widget creator" placement="bottom">
            <li>
              <Navlink
                href="/creator"
                classActive="bg-primary-600 hover:bg-primary-600"
          ...
          <Tooltip content="Your token settings" placement="bottom">
            <li>
              <Navlink
                href="/token"
                classActive="bg-primary-600 hover:bg-primary-600"
          ...
          <Tooltip content="Tokens balance" placement="bottom">
            <li>
              <Navlink
                href="/balance"
                classActive="bg-primary-600 hover:bg-primary-600"
